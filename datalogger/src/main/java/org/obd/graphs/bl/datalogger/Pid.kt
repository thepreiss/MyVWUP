...
enum class Pid(val id: Long) {
    ...
    ATM_PRESSURE_PID_ID(51),
    AMBIENT_TEMP_PID_ID(70),
    VEHICLE_SPEED_PID_ID(13),
    ENGINE_SPEED_PID_ID(12),
    FUEL_CONSUMPTION_PID_ID(7035),
    FUEL_LEVEL_PID_ID(47),
    GEARBOX_OIL_TEMP_PID_ID(7025),
    GEAR_ENGAGED_PID_ID(7029),
    OIL_TEMP_PID_ID(7003),
    COOLANT_TEMP_PID_ID(5),
    EXHAUST_TEMP_PID_ID(60),
    POST_IC_AIR_TEMP_PID_ID(7002),
    TOTAL_MISFIRES_PID_ID(17078),
    OIL_LEVEL_PID_ID(7014),
    ENGINE_TORQUE_PID_ID(7028),
    INTAKE_PRESSURE_PID_ID(11),
    DISTANCE_PID_ID(49),
    IBS_PID_ID(7020),
    BATTERY_VOLTAGE_PID_ID(66),
